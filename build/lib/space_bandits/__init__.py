...
from .core import BanditAlgorithm
from .core import ContextualDataset
from .algorithms import NeuralBanditModel
...
def init_linear_model(
    ...
    """
    from .algorithms import LinearFullPosteriorSampling
...
def init_neural_model(
    ...
    from .algorithms import NeuralLinearPosteriorSampling
